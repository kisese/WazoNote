 ...
 */
public class SecureEditActivity extends ActionBarActivity {
    NotesTableAdapter regadapter;
    NotesDBHelper openHelper;
    int rowId;
    Cursor c;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.action_edit:
                ...
                Intent intent = new Intent(SecureEditActivity.this, EditNoteActivity.class);
                intent.putExtra("headline", headline.getText());
                intent.putExtra("description", description.getText());
                SecureEditActivity.this.startActivity(intent);
