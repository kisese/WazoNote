 ...
 */
public class SecureMainActivity extends ActionBarActivity{
    ...
    public void clickFunctions(){
        myNotes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent noteList = new Intent(SecureMainActivity.this, SecureListActivity.class);
                SecureMainActivity.this.startActivity(noteList);
        ...
        newNote.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent noteMpya = new Intent(SecureMainActivity.this, SecureNewActivity.class);
                SecureMainActivity.this.startActivity(noteMpya);
            }
        });
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(SecureMainActivity.this, SecureActivity.class);
        SecureMainActivity.this.startActivity(intent);
        super.onBackPressed();
    }
}
